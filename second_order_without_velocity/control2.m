function [sys,x0,str,ts] = control2(t,x,u,flag,F,L,n) % 
...
%系统的输出
function sys=mdlOutputs(t,x,u,F,L,n) % 

%sys = F*u(1:n) + L*u(n+1:2*n);  
sys = F*u(1:n) + u(n+1:2*n);
